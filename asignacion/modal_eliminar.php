<div class="modal modal-blur fade" id="modal_eliminar_asignacion" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-4">
                ...
                <div class="text-secondary">¿Está seguro de que desea eliminar este registro?</div>
            ...
            <div class="modal-footer">
                <div class="w-100">
                    <div class="row">
                        ...
                        <div class="col"><button type="button" class="btn btn-danger w-100" onclick="borrar_asignacion($('#id_asignacion').val())">Aceptar</button></div>
                    </div>
                </div>
            </div>
        </div>
