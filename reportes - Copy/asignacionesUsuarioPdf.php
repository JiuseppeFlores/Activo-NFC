...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $sql = "SELECT tas.*, tp.producto, tp.codigoBarras FROM tblAsignacion tas LEFT JOIN tblUsuario tu ON tu.idUsuario = tas.idUsuario LEFT JOIN tblProducto tp ON tas.idProducto = tp.idProducto WHERE tu.idUsuario = $idUsuario ORDER BY tas.idAsignacion ASC;";
    ...
    if (count($listaAsignaciones) == 0) {
        $table .= '<tr><td colspan="29" align="center">El usuario no tiene productos asignados.</td></tr>';
    } else {
