<div class="modal modal-blur fade" id="modal_eliminar_rol" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-footer">
                <div class="w-100">
                    <div class="row">
                        ...
                        <div class="col"><button type="button" class="btn btn-danger w-100" onclick="borrar_rol($('#id_rol').val())">Aceptar</button></div>
                    </div>
                </div>
            </div>
        </div>
